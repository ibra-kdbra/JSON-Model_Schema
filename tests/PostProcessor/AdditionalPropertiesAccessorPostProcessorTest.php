...
class AdditionalPropertiesAccessorPostProcessorTest extends AbstractPHPModelGeneratorTest
{
    ...
    public function testAdditionalPropertiesAreSerializedWithoutAdditionalPropertiesAccessorPostProcessor(): void
    {
        ...
        $object = new $className(['name' => 'Late autumn', 'start' => '2023-10-10']);
        $this->assertEqualsCanonicalizing(['name' => 'Late autumn', 'start' => '20231010'], $object->toArray());

        $object->populate(['end' => '20231212']);
        $this->assertEqualsCanonicalizing(
            ['name' => 'Late autumn', 'start' => '20231010', 'end' => '20231212'],
            $object->toArray()
        );
    }
